class Registry:
    ...
    def register_chatmodel(cls):
        def wrap(model_cls):
            ...
            assert issubclass(
                model_cls, BaseChat), "All Chat Models must inherit BaseChat class"
    ...
    def register_task(cls):
        ...
        def wrap(task_cls):
            # from src.perspectives.base import BaseEval
    ...
    def register_metrics(cls):
        ...
        def wrap(metrics_cls):
            from src.metrics.base import BaseDatasetMetrics, BasePerSampleMetrics
